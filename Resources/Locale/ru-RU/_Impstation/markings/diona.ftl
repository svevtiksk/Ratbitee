...
marking-DionaCornflowerHead_colorable = Diona Cornflowers (Flowers, Colorable)
marking-DionaFicusHead_colorable = Diona Ficus (Leafs, Colorable)
marking-DionaFlowersBody_colorable = Diona Chest (Flowers, Colorable)
marking-DionaFlowersHead_colorable = Diona Head (Flowers, Colorable)
marking-DionaGarlandHead_colorable = Diona Garland (Flowers, Colorable)
marking-DionaKingHead_colorable = Diona Flowerking (Flower, Colorable)
marking-DionaLaurelHead_colorable = Diona Laurel (Leafs, Colorable)
marking-DionaLeafCover_colorable = Diona Leaf Cover
marking-DionaLeafyHeadTop_colorable = Diona Leafy (Leafs, Colorable)
marking-DionaLotusHead_colorable = Diona Lotus (Flower, Colorable)
marking-DionaMeadowHeadTop_colorable = Diona Meadow, Colorable
marking-DionaOakHead_colorable = Diona Oak (Snag, Colorable)
marking-DionaPalmHead_colorable = Diona Palmhead (Leafs, Colorable)
marking-DionaRootHead_colorable = Diona Root (Roots, Colorable)
marking-DionaRoseHead_colorable = Diona Rose (Flower, Colorable)
marking-DionaRoseyHead_colorable = Diona Rosey (Flowers, Colorable)
marking-DionaShrubHeadTop_colorable = Diona Shrub (Thorns, Colorable)
marking-DionaSpinnerHeadSide_colorable = Diona Spinner, Colorable
marking-DionaSproutHeadSide_colorable = Diona Sprout, Colorable
marking-DionaThornsBody_colorable = Diona Thorns (Body, Colorable)
marking-DionaThornsHead_colorable = Diona Thorns (Head, Colorable)
marking-DionaVineHeadTop_colorable = Diona Vines (Vines, Colorable)
