...
shadowling-role-greeting-short = You are a shadowling who has awakened in the body of { $name }.
thrall-role-greeting =
    You are a thrall.
    Help your Shadowling ascend by any means necessary.
shadowling-briefing = Shed from this lesser form and start your path to ascension.
thrall-briefing =
