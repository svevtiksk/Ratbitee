ent-ComputerAlert = atmospheric alerts computer
    .desc = Used to access the station's automated atmospheric alert system.
...
ent-ComputerShuttleSyndieDropPod = syndicate drop pod console
    .desc = Used to launch a drop pod. It's a one way trip, make sure you've packed your lunch.
...
ent-ComputerPsionicsRecords = psionics registry computer
