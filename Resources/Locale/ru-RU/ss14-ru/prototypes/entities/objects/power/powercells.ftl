...
ent-PowerCellMicrortg = micro radioisotope thermoelectric generator
    .desc = A rechargeable prototype micro-rtg cell. Has lower capacity but slowly recharges by itself. Doesn't have enough radiation shielding.
    .suffix = Full
ent-PowerCellMicrortgPrinted = { ent-PowerCellMicrortg }
    .suffix = Empty
    .desc = { ent-PowerCellMicrortg.desc }
