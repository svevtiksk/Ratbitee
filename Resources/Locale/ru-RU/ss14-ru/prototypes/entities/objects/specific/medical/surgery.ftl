...
ent-OmnimedToolLite = CMO's proto multitool
    .desc = A prototypical medical multitool designed by Nanotrasen to save valuable space in the backpacks of high ranking medical officers.
