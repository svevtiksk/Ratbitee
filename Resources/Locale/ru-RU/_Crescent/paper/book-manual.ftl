book-accelerated-conscript-training-manual-1 =
    ...
    The NCWL requires many hands to run a fleet. This section will teach you the bare minimum.
    Remember to always listen to your superiors for orders.
...
book-accelerated-conscript-training-manual-2 =
    ...
    Fixing power is very important. Without it no ship can function.
    When fixing the power grid follow these troubleshooting steps.
